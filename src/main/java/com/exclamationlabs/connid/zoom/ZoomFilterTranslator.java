...
public class ZoomFilterTranslator extends AbstractFilterTranslator<String> {

    private static final Log LOG = Log.getLog(ZoomFilterTranslator.class);

    @Override
    protected String createEqualsExpression(EqualsFilter filter, boolean not) {

        LOG.info("### Entered Zoom filter equals");
