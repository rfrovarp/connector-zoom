...
import com.exclamationlabs.connid.zoom.model.response.fault.ErrorResponse;
import com.exclamationlabs.connid.zoom.model.response.fault.ErrorResponseCode;
...
public class ZoomFaultProcessor {
    private static final Log LOG = Log.getLog(ZoomFaultProcessor.class);

    private GsonBuilder gsonBuilder;

    public ZoomFaultProcessor(GsonBuilder builder) {
        gsonBuilder = builder;
    }
    ...
    public void process(HttpResponse httpResponse) {
        ...
        try {
            ...
            handleFaultResponse(rawResponse);
    ...
    private void handleFaultResponse(String rawResponse) {
