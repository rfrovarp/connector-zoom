...
public class ZoomConnectorTest extends ConnectorMockRestTest {
    ...
    public void test110UserCreate() {
        ...
        attributes.add(new AttributeBuilder().setName(EMAIL.name()).addValue("test@tester.com").build());
    ...
    public void test120UserModify() {
        final String getUserResponseData = "{\"id\":\"ZpRAY4X9SEipRS9kS--Img\",\"group_ids\":[\"5555\"],\"first_name\":\"Alfred\",\"last_name\":\"Neuman\",\"email\":\"alfred@mad.com\",\"type\":2,\"pmi\":5825080948,\"timezone\":\"America/Chicago\",\"verified\":0,\"created_at\":\"2020-05-06T19:22:24Z\",\"last_login_time\":\"2020-05-10T19:37:29Z\",\"pic_url\":\"https://lh6.googleusercontent.com/-mboZtlAHsM4/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclRl5BboLrsXCiJ9dRBBD1yEIG2ww/photo.jpg\",\"language\":\"en-US\",\"phone_number\":\"\",\"status\":\"active\"}";
        final String addGroupResponseData = "{\"ids\":\"\",\"added_at\":\"2020-05-13T18:31:35Z\"}";
        ...
        attributes.add(new AttributeDeltaBuilder().setName(LAST_NAME.name()).
                addValueToReplace("Johnson").build());
        attributes.add(new AttributeDeltaBuilder().setName(USER_ID.name()).
                addValueToReplace("1234").build());

        attributes.add(new AttributeDeltaBuilder().setName(GROUP_IDS.name()).
                addValueToReplace("5678").build());
    ...
    public void test130UsersGet() {
        final String responseData = "{\"page_count\":1,\"page_number\":1,\"page_size\":30,\"total_records\":1,\"users\":[{\"id\":\"ZpRAY4X9SEipRS9kS--Img\",\"first_name\":\"Alfred\",\"last_name\":\"Neuman\",\"email\":\"alfred@mad.com\",\"type\":2,\"pmi\":5825080948,\"timezone\":\"America/Chicago\",\"verified\":0,\"created_at\":\"2020-05-06T19:22:24Z\",\"last_login_time\":\"2020-05-10T19:37:29Z\",\"pic_url\":\"https://lh6.googleusercontent.com/-mboZtlAHsM4/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclRl5BboLrsXCiJ9dRBBD1yEIG2ww/photo.jpg\",\"language\":\"en-US\",\"phone_number\":\"\",\"status\":\"active\"}]}";
    ...
    public void test140UserGet() {
        final String responseData = "{\"id\":\"ZpRAY4X9SEipRS9kS--Img\",\"group_ids\":[\"5555\"],\"first_name\":\"Alfred\",\"last_name\":\"Neuman\",\"email\":\"alfred@mad.com\",\"type\":2,\"pmi\":5825080948,\"timezone\":\"America/Chicago\",\"verified\":0,\"created_at\":\"2020-05-06T19:22:24Z\",\"last_login_time\":\"2020-05-10T19:37:29Z\",\"pic_url\":\"https://lh6.googleusercontent.com/-mboZtlAHsM4/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuclRl5BboLrsXCiJ9dRBBD1yEIG2ww/photo.jpg\",\"language\":\"en-US\",\"phone_number\":\"\",\"status\":\"active\"}";
        prepareMockResponse(responseData);
    ...
    public void test210GroupCreate() {
        ...
        attributes.add(new AttributeBuilder().setName(GROUP_NAME.name()).addValue("role name1").build());
    ...
    public void test220GroupModify() {
        ...
        attributes.add(new AttributeDeltaBuilder().setName(GROUP_NAME.name()).
                addValueToReplace("role name2").build());
    ...
    public void test230GroupsGet() {
        final String responseData = "{\"total_records\":3,\"groups\":[{\"id\":\"tAKM1nXqSSS4kgtNu91_uQ\",\"name\":\"Alpha Flight\",\"total_members\":0},{\"id\":\"loiFdqtuR4WoCq2Rn3G8uw\",\"name\":\"Avengers\",\"total_members\":0},{\"id\":\"nu7kJQ4PRwWrlyXoGHHopg\",\"name\":\"West Coast Avengers\",\"total_members\":0}]}";
        prepareMockResponse(responseData);
        List<String> idValues = new ArrayList<>();
        List<String> nameValues = new ArrayList<>();
        ResultsHandler resultsHandler = ConnectorTestUtils.buildResultsHandler(idValues, nameValues);
    ...
    public void test240GroupGet() {
        final String responseData = "{\"id\":\"AxBcuvQeQSaP-Imhrludgw\",\"name\":\"Alpha Flight\",\"total_members\":0}";
        prepareMockResponse(responseData);
        List<String> idValues = new ArrayList<>();
        List<String> nameValues = new ArrayList<>();
        ResultsHandler resultsHandler = ConnectorTestUtils.buildResultsHandler(idValues, nameValues);
