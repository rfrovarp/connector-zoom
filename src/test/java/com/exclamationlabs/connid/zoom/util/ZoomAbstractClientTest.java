...
abstract public class ZoomAbstractClientTest {
    ...
    @Before
    public void setup() {
        ZoomConfiguration configuration = new TestZoomConfiguration();
        configuration.configureProperties();

        connection = new ZoomConnection(configuration, new ZoomJWTAuthenticator() {
